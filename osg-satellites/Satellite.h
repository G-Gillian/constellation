...
class Satellite : public cSimpleModule
{
  ...
  protected:
    ...
    virtual int getGate(int targetNode);
    virtual bool isConnected(const Graph& graph, int node1, int node2);
    virtual ExtractedData extractData(const std::string& str);
};
